...
ActiveRecord::Schema.define(version: 20140820185629) do
  ...
  add_index "ambassadors", ["country_id"], name: "index_ambassadors_on_country_id", using: :btree
  ...
  add_index "dialogue_participants", ["email"], name: "email", unique: true, using: :btree
  ...
  add_index "participants", ["email"], name: "email", unique: true, using: :btree
